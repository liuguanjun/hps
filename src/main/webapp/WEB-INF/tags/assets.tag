...
<c:choose>
    ...
    <c:when test="${sessionScope.debugAssets}">
        ...
        <link rel="stylesheet" type="text/css" href="${base}/styles/easyui/themes/default/easyui.css">
	    ...
	    <script type="text/javascript" src="${base}/scripts/jquery.easyui.min.js"></script>
		<script type="text/javascript" src="${base}/scripts/easyui-lang-zh_CN.js"></script>
		<script type="text/javascript" src="${base}/scripts/json2.js"></script>
		<script type="text/javascript" src="${base}/scripts/hpscommon.js"></script>
    </c:when>
    <c:otherwise>
